...
int main()
{
	...
	basket.push_back(std::make_shared<Quote>("abc", 5.5));
	basket.push_back(std::make_shared<Bulk_quote>("abc", 5.5, 10, 0.2));
	basket.push_back(std::make_shared<Limit_quote>("abc", 5.5, 10, 0.2));
